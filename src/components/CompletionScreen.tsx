...
const CompletionScreen: React.FC = () => {
  const { stats, civilizationName, history, reset } = useCivilizationStore();
      ...
      <div className="flex justify-center">
        <button
          ...
          className="
            ...
            text-white font-serif text-2xl font-bold
          ...
          "
        >
          <RotateCcw className="w-7 h-7 group-hover:rotate-[-360deg] transition-transform duration-500" />
          <span>开启新的文明之旅</span>
        </button>
      </div>
    </div>
